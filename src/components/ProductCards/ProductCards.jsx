...
const products = [
    ...
    },
    {
        ...
        desc: 'Premium home inverters and long-life batteries from India\'s most trusted brands — Havells, Eastman, Asha Power, and more. Expert installation and after-sales service guaranteed.',
        points: [
            'Top brands: Havells, Eastman, Asha Power',
        ...
        >
            {imgs.map((src, i) => (
                <img
                    ...
                    src={src}
                    alt={`${title} ${i + 1}`}
                    className={`pc-slider-img${i === activeIdx ? ' pc-slider-img--active' : ''}`}
                    style={{
                        objectFit: fit || 'cover',
                ...
                {products.map((p, i) => (
                    ...
                    >
                        <div className="pc-card-inner container">
                            ...
                            {/* Right: Image */}
                            <div className="pc-img-wrap" style={{ backgroundColor: p.imgBg || 'transparent' }}>
                                {p.imgs ? (
                                    <ImageSlider imgs={p.imgs} title={p.title} fit={p.fit} imgBg={p.imgBg} />
                                ) : (
                                    <img
                                        src={p.img}
                                        alt={p.title}
