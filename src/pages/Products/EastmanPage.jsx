  ...
  return (
    ...
    >
      ...
      <div className="prod-body">
        ...
        {product.warranty && <p className="prod-tc">*T&C Apply</p>}
...
function CategoryNav({ activeId }) {
  ...
  const inverters = [
    { id: "section-grid-tie", label: "Solar Grid Tie Inverter" },
    {
      ...
      label: "Solar Hybrid Inverter IP65 - Low Voltage",
    },
    {
      id: "section-hybrid-hv",
      label: "Solar Hybrid Inverter IP65 - High Voltage",
    },
  ...
  return (
    <div
      className="prod-cat-nav"
      role="navigation"
      aria-label="Eastman product categories"
    >
      <div className="container prod-cat-inner">
        ...
        >
          ...
          <div
            className={`prod-cat-dropdown-menu${dropdownOpen ? " prod-cat-dropdown-menu--open" : ""}`}
            role="menu"
          >
      ...
      >
        ...
        <div className="container page-hero-content">
          ...
          <p className="page-hero-sub">
            India's #1 solar brand — grid tie inverters, hybrid inverters,
            lithium batteries, tubular batteries, and high-efficiency panels.
          </p>
