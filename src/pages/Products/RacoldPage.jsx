      ...
      <div className="racold-prod-body">
        ...
        <div className="racold-prod-info-boxes">
          <div className="racold-prod-info-box racold-prod-info-box--range">
            <svg
              className="racold-prod-info-icon"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
  ...
  return (
    <section id={section.id} className="racold-prod-section">
      <div className="container">
        <div
          ref={sectionRef}
          className={`section-header text-center fade-in-up ${inView ? "visible" : ""}`}
        >
        ...
        >
          ...
          <div className="container page-hero-content">
            ...
            <p className="page-hero-sub">
              Energy-efficient solar water heaters and heat pumps for every
              Indian home.
            </p>
