  ...
  return (
    ...
    >
      ...
      <div className="asha-prod-body">
        ...
        {product.warranty && <p className="asha-prod-tc">*T&C Apply</p>}
...
function CategoryNav({ activeId }) {
  return (
    <div
      className="asha-cat-nav"
      role="navigation"
      aria-label="Asha Power product categories"
    >
      ...
      >
        ...
        <div className="container page-hero-content">
          ...
          <p className="page-hero-sub">
            Digital power systems & solar solutions — hybrid inverters, grid
            tie, off-grid, lithium batteries, panels, and solar water pumps.
          </p>
