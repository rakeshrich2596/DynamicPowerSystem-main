...
function ProductCard({ product, delay = 0, index = 0 }) {
  ...
  return (
    ...
    >
      {product.badge && <span className="vg-prod-badge">{product.badge}</span>}
      ...
      <div className="vg-prod-body">
        ...
        <div className="vg-prod-info-boxes">
          ...
          {product.warranty && (
            <div className="vg-prod-info-box vg-prod-info-box--warranty">
              <svg
                className="vg-prod-info-icon"
                viewBox="0 0 24 24"
                fill="none"
              ...
              >
                <path
                  d="M12 2L4 5v6c0 5.25 3.4 10.16 8 11 4.6-.84 8-5.75 8-11V5l-8-3zm0 4.2l5 1.88v2.82c0 3.88-2.3 7.4-5 8.38-2.7-.98-5-4.5-5-8.38V8.08L12 6.2z"
                  fill="currentColor"
                />
              </svg>

              <div>
                <span className="vg-prod-info-value">{product.warranty}</span>

                <span className="vg-prod-info-label">Warranty</span>
              </div>
            </div>
          )}
        </div>
...
function CategoryNav({ activeId }) {
  return (
    <div
      className="vg-cat-nav"
      role="navigation"
      aria-label="V-Guard product categories"
    >
      ...
      >
        ...
        <div className="container page-hero-content">
          ...
          <p className="page-hero-sub">
            Thoughtful and energy-efficient water heating solutions. Domestic,
            Commercial, and EVI series for reliable performance in all weather
            conditions.
          </p>
