...
function ProductCard({ product, delay = 0, index = 0 }) {
  ...
  return (
    ...
    >
      {product.badge && <span className="hv-prod-badge">{product.badge}</span>}
      ...
      <div className="hv-prod-body">
        ...
        <ul className="hv-prod-highlights">
          {product.highlights.map((h) => (
            <li key={h}>
              <span className="hv-highlight-dash">—</span>
              {h}
            </li>
          ))}
        </ul>
...
function CategoryNav({ activeId }) {
  return (
    <div
      className="hv-cat-nav"
      role="navigation"
      aria-label="Havells product categories"
    >
      ...
      >
        ...
        <div className="container page-hero-content">
          ...
          <p className="page-hero-sub">
            Trusted residential solar solutions — high-efficiency MonoPERC &amp;
            TOPCon panels and certified Enviro GTi solar inverters with built-in
